    ...
    angular
        ...
        .controller('SignUpController', function ($ionicPopup, $state, $rootScope, $cordovaLocalNotification,
            ...
            function createFigoUser() {
                self.email="timcxlab@gmail.com";
                self.password="GFTCXLAB";
                //FigoFactory.createFigoUser(self.email, self.password, self.fullName).then(function (userData) {
                FigoFactory.createMongoUser(self.email, self.password, self.fullName).then(function (userData) {
            ...
            function saveAccount(accountToSave) {
                ...
                var userid = accountToSave.accountInfo.userId.toLowerCase();
                var pin = accountToSave.accountInfo.pin.toLowerCase();
